...
pub(crate) fn legacy_help_text() -> String {
    [
        ...
        "                                    Run Binance public WSS bookTicker all-market monitor and serve /api/binance-wss-book-ticker/status",
        ...
        "                                    Run Bybit public WSS orderbook.1 all-market monitor and serve /api/bybit-wss-book-ticker/status",
        "  okx-wss-book-ticker [--bind 127.0.0.1:8807] [--symbol ALL_USDT|BTC-USDT] [--market spot|swap] [--reconnect-delay-secs 2] [--once --updates 3]",
        "                                    Run OKX public WSS tickers monitor and serve /api/okx-wss-book-ticker/status",
        "  bitget-wss-book-ticker [--bind 127.0.0.1:8809] [--symbol ALL_USDT|BTCUSDT] [--market spot|usdt-futures] [--reconnect-delay-secs 2] [--once --updates 3]",
        "                                    Run Bitget public WSS ticker monitor and serve /api/bitget-wss-book-ticker/status",
        ...
        "                                    Run Aster public WSS bookTicker monitor and serve /api/aster-wss-book-ticker/status",
        "  hyperliquid-wss-book-ticker [--bind 127.0.0.1:8795] [--symbol ALL_USDT|BTC] [--market perp] [--reconnect-delay-secs 2] [--once --updates 3]",
        "                                    Run Hyperliquid public WSS bbo monitor and serve /api/hyperliquid-wss-book-ticker/status",
