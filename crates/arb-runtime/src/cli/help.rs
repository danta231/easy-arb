...
pub(crate) fn legacy_help_text() -> String {
    [
        ...
        "  funding-arb-monitor [--bind 127.0.0.1:8804] [--interval-secs 5] [--clear-sources --source venue=url] [--funding-carry-mode perp_perp,perp_perp_staggered] [--min-net-funding-bps 5] [--execution-reports file] [--resident-events file] [--opportunity-history file] [--once] [--out dir]",
