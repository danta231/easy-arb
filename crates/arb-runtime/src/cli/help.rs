...
pub(crate) fn legacy_help_text() -> String {
    [
        ...
        "  lighter-wss-book-ticker [--bind 127.0.0.1:8824] [--symbol ALL_USDT|BTC[,ETH]] [--market perp] [--reconnect-delay-secs 2] [--once --updates 3]",
        "                                    运行 Lighter 公开 WSS ticker 只读 monitor，并提供 /api/lighter-wss-book-ticker/status",
        "  gate-wss-book-ticker [--bind 127.0.0.1:8825] [--symbol ALL_USDT|BTC_USDT[,ETH_USDT]] [--market usdt-futures] [--reconnect-delay-secs 2] [--once --updates 3]",
        "                                    运行 Gate 公开 WSS futures.book_ticker 只读 monitor，并提供 /api/gate-wss-book-ticker/status",
        ...
        "  funding-arb-monitor [--bind 127.0.0.1:8804] [--interval-secs 5] [--clear-sources --source venue=url] [--funding-carry-mode perp_perp,perp_perp_staggered] [--min-net-funding-bps 5] [--execution-reports file] [--resident-events file] [--opportunity-history file] [--exchange-pnl-config file] [--once] [--out dir]",
        ...
        "  funding-arb-resident-live [--snapshot file | --source venue=url] [--pair-id id] [--config file] [--funding-settlement-raw-snapshot file] [--private-order-events-dir dir] [--interval-secs 60] [--max-cycles n] [--notional-usd amount --max-total-notional-usdt amount] [--funding-carry-mode perp_perp,perp_perp_staggered] [--hyperliquid-user 0x...] [--hyperliquid-source a|b] [--hyperliquid-asset-id BTCUSDT=0] [--aster-user 0x...] [--aster-signer 0x...] [--execute-live --i-understand-funding-arb-live-orders] [--allow-unknown-recovery] [--disable-auto-residual-de-risk] [--exit-only]",
        ...
        "  funding-carry-resident-live      Alias for funding-arb-resident-live perp funding-carry modes; spot_perp is served by multi-venue-basis-resident-live with the same live safety controls",
